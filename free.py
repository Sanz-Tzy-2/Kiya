...
\x1b[0;96m /_/ /_/ /_/_____/_/    || FACEBOOK
\x1b[0;96m╔══════════════════════════════════════════════╗
...
\x1b[0;96m╠══[\x1b[0;93m•\x1b[0;96m]\x1b[0;93m Facebook : Facebook.com/MyAangXD    \x1b[0;96m║
\x1b[0;96m╚══════════════════════════════════════════════╝
""")
def menu_log():
...
def menu():
    ...
    print('%s║'%(O))
    print('%s╠══[%s•%s] %sYou ID : %s'%(O,K,O,P,i))
    print('%s╠══[%s•%s] %sYou IP : %s'%(O,K,O,P,ip))
    print('%s║'%(O))
